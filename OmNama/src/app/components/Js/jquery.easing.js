...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzIxODA0OTY0OjhjYTU5Yjc2OWQzNWRjM2ZhZjk4Y2M4ODk4NmY4Njk0MGZkN2VhZjdiOTYzNTFjMTMzYjQ0ZGY5NTllMDRkZmE=--cc561f1e55ee5cc0b81b738a1dd804e1de628d43">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="B212:7206:284F8BE:44F2F64:5BB365DC" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="B212:7206:284F8BE:44F2F64:5BB365DC" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="25150458" /><meta name="octolytics-actor-login" content="sridhararjun" /><meta name="octolytics-actor-hash" content="cd17ae47c190f43faa7a9f99a65a61cd99e11d732fa3514928c6488cb132ed0b" />
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="7041cb30a48b78240faa72b5f44f18a1" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="sridhararjun">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="html-safe-nonce" content="aeb8b2d4ef660db56cd7d753c03e219a2dd3b7a4">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="25714616" data-scoped-search-url="/BlackrockDigital/startbootstrap-scrolling-nav/search" data-unscoped-search-url="/search" action="/BlackrockDigital/startbootstrap-scrolling-nav/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=ZE9kgK6i7PBZkxqFJxCLzJeA+JNn9uJg4NcZY/wFdx8n7ozQREOSs2ebekrnV3m7prrxlk+VHybZNJLXEFAW6A=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:unread" data-channel="notification-changed:25150458" href="/notifications">
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <div class="dropdown-header">
    ...
    <a role="menuitem" class="dropdown-item" href="/BlackrockDigital/startbootstrap-scrolling-nav/issues/new" data-ga-click="Header, create new issue">
      New issue
    </a>
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@sridhararjun" class="avatar float-left mr-1" src="https://avatars0.githubusercontent.com/u/25150458?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="header-nav-current-user css-truncate"><a role="menuitem" class="no-underline user-profile-link px-3 pt-2 pb-2 mb-n2 mt-n1 d-block" href="/sridhararjun" data-ga-click="Header, go to profile, text:Signed in as">Signed in as <strong class="css-truncate-target">sridhararjun</strong></a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/sridhararjun" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/sridhararjun?tab=repositories" data-ga-click="Header, go to repositories, text:your repositories">Your repositories</a></li>


          <li><a role="menuitem" class="dropdown-item" href="/sridhararjun?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
            <li><a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, your gists, text:your gists">Your gists</a></li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="https://help.github.com" data-ga-click="Header, go to help, text:help">Help</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/settings/profile" data-ga-click="Header, go to settings, icon:settings">Settings</a></li>
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="brX+7ymI8+FSGDPpKiOCH0kJQSpxRIuEcKl5Z/ZYV6vYFcQqBsE8KBKTZj0klE5M4s7wRmkNcB4fkny4W4xNlA==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="tM4YDOLt9GY8KwDKW9/m9zbiwmVPz4hwRCUl1MzU0yYCbiLJzaQ7r3ygVR5VaCqknSVzCVeGc+orHiALYQDJGQ==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-remote="true" class="js-social-form js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="/lHboAoOlqJqp4jgyZpknnKeuejg0eejO8z0daOicRYOkgr+AH5/3As1lzsKG7OeQzvqTVxqt4T29kDLNzDZtg==" />      <input type="hidden" name="repository_id" id="repository_id" value="25714616" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/BlackrockDigital/startbootstrap-scrolling-nav/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="lgyXFWdMdKvIHOSL0AUY/IYr3ao/XbAfA3kzKS2QLuOBfJOrOZLWYBoCws+wYM45nCjL3I6AqyfozBzUNH9Llg==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/BlackrockDigital/startbootstrap-scrolling-nav/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="UL4g7E7rtcZd9oaXQCG7dqqJpAkNTvc9V/hWYT847YF405+Jfi6Z2gTTE/tXSTRLJamU1d/YAZXo3nEaAYMlsg==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/BlackrockDigital/startbootstrap-scrolling-nav/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="J2FMi/VnJeVJeEAmZZFhs10XiXp+BjtQpfAZBDEKnnXz4P77o97ndAoDZ/dNyqhTfLTSrorETBuLQ80bk+0RGw==" />
            <button
                type="submit"
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a class="js-selected-navigation-item selected reponav-item" itemprop="url" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /BlackrockDigital/startbootstrap-scrolling-nav" href="/BlackrockDigital/startbootstrap-scrolling-nav">
  ...
  <a class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse alerts /BlackrockDigital/startbootstrap-scrolling-nav/pulse" href="/BlackrockDigital/startbootstrap-scrolling-nav/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/BlackrockDigital/startbootstrap-scrolling-nav/blob/e51296b13cd0b6ed5c86761d75335fae19165c6d/vendor/jquery-easing/jquery.easing.js">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:ccc99223c6e3fa76b97b5db8b9d6a77c -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/BlackrockDigital/startbootstrap-scrolling-nav"><span>startbootstrap-scrolling-nav</span></a></span></span><span class="separator">/</span><span class="js-path-segment"><a data-pjax="true" href="/BlackrockDigital/startbootstrap-scrolling-nav/tree/master/vendor"><span>vendor</span></a></span><span class="separator">/</span><span class="js-path-segment"><a data-pjax="true" href="/BlackrockDigital/startbootstrap-scrolling-nav/tree/master/vendor/jquery-easing"><span>jquery-easing</span></a></span><span class="separator">/</span><strong class="final-path">jquery.easing.js</strong>
    </div>
  </div>


  <include-fragment src="/BlackrockDigital/startbootstrap-scrolling-nav/contributors/master/vendor/jquery-easing/jquery.easing.js" class="commit-tease commit-loader">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/BlackrockDigital/startbootstrap-scrolling-nav/raw/master/vendor/jquery-easing/jquery.easing.js">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/BlackrockDigital/startbootstrap-scrolling-nav/blame/master/vendor/jquery-easing/jquery.easing.js">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/BlackrockDigital/startbootstrap-scrolling-nav/commits/master/vendor/jquery-easing/jquery.easing.js">History</a>
    </div>

        <a class="btn-octicon tooltipped tooltipped-nw"
           href="x-github-client://openRepo/https://github.com/BlackrockDigital/startbootstrap-scrolling-nav?branch=master&amp;filepath=vendor%2Fjquery-easing%2Fjquery.easing.js"
           aria-label="Open this file in GitHub Desktop"
           data-ga-click="Repository, open with desktop, type:windows">
            <svg class="octicon octicon-device-desktop" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/></svg>
        </a>

          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/BlackrockDigital/startbootstrap-scrolling-nav/edit/master/vendor/jquery-easing/jquery.easing.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="LFXEU6Xub7fDrTJNcxUrcWfkkXcLWQcG8hPIQMCZOZJkiojzZON/dGuMwaznsuqIGN5Xp8eBEKkkND7BWS4jaQ==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/BlackrockDigital/startbootstrap-scrolling-nav/delete/master/vendor/jquery-easing/jquery.easing.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="BuDYhsWeK8lJcJkWFkI4bboN8KvjfA2GiqFq/O/0qP7tbdTdvvLCsrPPXb6i1LutH7A8M+c14y0gS5a8gj823w==" />
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/BlackrockDigital/startbootstrap-scrolling-nav/blame/e51296b13cd0b6ed5c86761d75335fae19165c6d/vendor/jquery-easing/jquery.easing.js">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.23200s from unicorn-5bfdf5c777-s4lxl">GitHub</span>, Inc.</li>
